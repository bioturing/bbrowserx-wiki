...
echo -e "${_BLUE}BioTuring ecosystem RHEL installation version${_NC} ${_GREEN}1.0.0${_NC}\n"
...
sudo mv ./cert/bundles.crt /etc/pki/ca-trust/source/anchors/
sudo chmod +x /etc/pki/ca-trust/source/anchors/bundles.crt
